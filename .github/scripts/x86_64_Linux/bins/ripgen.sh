...
if [ "${SKIP_BUILD}" == "NO" ]; then
     ...
     export BIN="ripgen" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/resyncgg/ripgen" #github/gitlab/homepage/etc for $BIN
