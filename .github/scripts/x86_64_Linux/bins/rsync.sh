...
if [ "${SKIP_BUILD}" == "NO" ]; then
     ...
     export BIN="rsync" #Name of final binary/pkg/cli, sometimes differs from $REPO
     export SOURCE_URL="https://github.com/WayneD/rsync" #github/gitlab/homepage/etc for $BIN
